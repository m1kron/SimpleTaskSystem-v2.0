...
public:
	...
	virtual const ITaskHandle* CreateNewTask( sts::TTaskFunctionPtr task_function, const ITaskHandle* parent_task_handle ) = 0;
	...
	//virtual bool SubmitTaskBatch( const TaskBatch& batch ) = 0;
